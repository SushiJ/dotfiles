...
local user_theme = awful.util.getdir("config") .. "themes/mytheme/theme.lua"
beautiful.init(user_theme)
theme.icon_theme = "adwaita-xfce"
...
vicious.register(myweatherwidget, vicious.widgets.weather, function(_widget, args)
	weather_t:set_text(
		"City: "
			.. args["{city}"]
			.. "\nWind: "
...
-- mylauncher = awful.widget.launcher({ image = beautiful.opensuse_icon, menu = mymainmenu })
