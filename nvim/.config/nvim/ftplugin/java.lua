...
config.cmd = { '/home/sushi/.local/share/nvim/mason/bin/jdtls' }
...
local function get_jdtls_paths()
  ...
  path.runtimes = {
    ...
    {
      name = 'JavaSE-24',
      path = vim.fn.expand '~/.local/share/mise/installs/java/openjdk-24.0.0/',
    },
    -- {
    --   name = 'JavaSE-23',
...
jdtls.start_or_attach {
  ...
  root_dir = jdtls.setup.find_root(config.root_files),
  flags = {
